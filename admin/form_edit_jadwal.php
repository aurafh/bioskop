                    ...
                    <div class="row p-3">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-secondary" id="tanggal" name="tanggal" value="<?php echo $row['tanggal']; ?>">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="jam" class="form-label mt-2">Jam</label>
                                <input type="text" class="form-control text-secondary" id="jam" name="jam" value="<?php echo $row['jam']; ?>">
                            </div>
                            <div class="form-group">
