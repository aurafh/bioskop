...
<body>
    ...
    <main>
        <div class="container mb-5">
            <h3 class="my-5">Tambah Data Film</h3>
            <form class="form-control shadow" method="post" action="cek_tambah_film.php" enctype="multipart/form-data">
                <div class="row p-3">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control text-secondary" id="sinopsis" name="sinopsis"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="durasi" class="form-label">Durasi</label>
                            <input type="text" class="form-control text-secondary" id="durasi_tayang" name="durasi_tayang">
                        </div>
                        <div class="form-group">
                            <label for="tahun_tayang" class="form-label mt-2">Tahun Tayang</label>
                            <input type="number" class="form-control text-secondary" id="tahun_tayang" name="tahun_tayang">
                        </div>
                        <div class="form-group">
                            <label for="image" class="form-label mt-2">Image</label>
                            <input type="file" class="form-control text-secondary" id="image" name="image" accept=".png,.jpeg,.jpg" arialabel="fileexample">
                        </div>
                    </div>
                </div>
                <hr class="mt-3">
                <button class="btn btn-primary mx-3 mb-3" type="submit">Tambah Film</button>
            </form>
        </div>
    </main>
