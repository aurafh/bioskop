                ...
                <tbody>
                    ...
                    while ($fil = mysqli_fetch_array($query)) { ?>
                        <tr class="text-center">
                            ...
                            <td><img src="../assets/image/<?= $fil['image']; ?>" alt="..." width="60" height="85"></td>
                            <td scope="col">
                                <a href="form_edit_film.php?id_film=<?= $fil['id_film']; ?>" class="btn btn-sm btn-warning">Ubah</a>
                                <a href="hapus_film.php?id_film=<?= $fil['id_film']; ?>" type="button" class="btn btn-danger btn-sm">Hapus</a>
                            </td>
                        </tr>
                    <?php
                    } ?>
